<div style="border: 1px solid #EFEFEF;padding: 0px 15px 15px;">
	  ...
	  <tbody>
		...
		<tr align="right">
		  <td style="font-size: 14px;">                      
			  ...
			  <a href="{router page='wall'}" style="color: #6c6b6b; text-decoration:none; margin-right: 35px;">Стена</a>
			  <a href="{router page='comments'}" style="color: #6c6b6b; text-decoration:none;margin-right: 35px;">Прямой эфир</a>
			  <a href="{router page='blog'}albums/" style="color: #6c6b6b; text-decoration:none;">Фотоальбомы</a>
		  </td>
		</tr>
				...
				<table style="">
					<tr>
						<td style="color: #646262; font-family: 'Raleway', arial; font-size: 23px; text-align:center; font-weight:200;" align="center">
						  <span style="color:#8B8B8B; font-weight: 500;">Слово</span>  - изографам
						  <br><span style="color:#8B8B8B;font-size: 14px">Православный Иконописный Портал</span>
						</td>
					</tr>
				</table>
			</td>
	...
	<ul style="list-style:none; margin-right: 40px;">
		{foreach from=$aTopics item=oTopic}
			...
			<li>
				<table style="border: 1px solid #F0F0F0;padding: 15px 20px 10px; width: 100%;">		
					<tr style="height: 50%;">
						<td rowspan="2" style="vertical-align: top; width: 260px;">
							<img src="{if $oTopic->getPreviewImageUrl()}{$oTopic->getPreviewImageUrl('254x160crop')}{else}http://orthograf.ru/common/templates/skin/experience/assets/images/no-photo.jpg{/if}" alt="topic_preview" style="padding: 15px 30px 15px 16px;"/>
						</td>
	...
	<table border="0" style="width: 100%;">
	    <tr>
			<td align="center">         
				<table align="center" style="background: #EC877B; text-align:center;">
				  <tr>
		...
		<tr style="background:#38404b;">
			<td style="text-align:center; font-size: 14px; padding-top: 25px;">
			  ...
			  <a href="{router page='wall'}" style="color: #bcc9dd; text-decoration:none; margin-right: 35px;">Стена</a>
			  <a href="{router page='comments'}" style="color: #bcc9dd; text-decoration:none;margin-right: 35px;">Прямой эфир</a>
			  <a href="{router page='blog'}albums/" style="color: #bcc9dd; text-decoration:none;">Фотоальбомы</a>
			</td>
	    </tr>
	    <tr style="background:#38404b;">
			<td style="color: #bcc9dd; height:70px; text-align:center;  font-weight: 400; font-size: 12px;">
			  © 2014 <a href="{router page='index'}" target="_blank" style="text-decoration:none; color:#e9edf4;">Портал "Слово - изографам"</a>. Все права защищены
			</td>
	    </tr>
	</table>
	{/if}
